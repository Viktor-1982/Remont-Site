...
![Floating Floor Structure Detail](/images/posts/soundproofing-2026/floating-floor-acoustics-en.jpg "Diagram of the acoustic floating floor assembly with numbered layers")

### Anatomy of an Engineered Floating Floor Assembly (as diagrammed):
* **Hollow Core Slab**: Structural load-bearing concrete floor base, thoroughly cleaned and cleared of debris.
* **Moisture Barrier**: Heavy-duty 6 mil (150–200 µm) polyethylene membrane protecting the insulation core from moisture and cement slurry.
* **Sound Insulation Layer**: High-density acoustic mineral wool boards (6.2–8.7 lbs/cu ft or 100–140 kg/m³, 0.8"–1.2" thick) dampening impact and airborne transmission.
* **Floor Screed**: Minimum 2.0"–2.4" (50–60 mm) fiber-reinforced mortar screed floating entirely isolated above the resilient core.
* **Reinforcement Mesh**: Embedded welded wire grid (2"x2" / 50x50 mm) providing tensile strength and preventing cracking.
* **Edge Strip**: Closed-cell perimeter damping foam strip preventing structural flanking vibrations to adjoining walls.
* **Wall**: Main boundary wall completely decoupled from the floating floor slab.
