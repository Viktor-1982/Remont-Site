...
| Noise Category | Common Sources | Proven Engineering Solution |
| :--- | :--- | :--- |
| **Airborne Noise** | Voices, TV audio, music, barking dogs | **Mass + Cavity Absorption**: Dual-layer GWB/drywall with dense mineral wool in cavity |
| **Impact Noise** | Footsteps, running, dropped objects, dragging chairs | **Decoupled Floating Floor**: Screed over high-density acoustic mats with edge tape |
| **Structural / Flanking** | Elevators, plumbing pumps, hammer drills, subwoofers | **Mechanical Decoupling**: Resilient sound isolation clips, isolation tape, and caulk |
...
### Anatomy of an Engineered Floating Floor Assembly (as diagrammed):
* **Hollow Core Concrete Slab**: Structural load-bearing concrete floor base, thoroughly cleaned and cleared of debris.
* **Waterproofing Membrane (Vapor Barrier)**: Heavy-duty 6 mil (150–200 µm) polyethylene sheeting protecting the insulation core from moisture and cement slurry.
* **Sound Insulation Material (Acoustic Board)**: High-density acoustic mineral wool boards (6.2–8.7 lbs/cu ft or 100–140 kg/m³, 0.8"–1.2" thick) dampening impact and airborne vibrations.
* **Cement-Sand Screed (Cementitious Screed)**: Minimum 2.0"–2.4" (50–60 mm) fiber-reinforced mortar screed floating entirely isolated above the resilient core.
* **Reinforcing Mesh (Embedded in Screed)**: Welded wire grid (2"x2" / 50x50 mm) shown partially exposed in the diagram for visual clarity, but physically installed on chairs **inside the body of the screed** to resist tensile cracking.
* **Damper Tape (Perimeter Isolation Strip)**: Closed-cell perimeter damping foam strip preventing structural flanking vibrations to adjoining walls.
* **Base (Wall / Structural Perimeter)**: Main boundary wall completely decoupled from the floating floor slab.

### 3 Non-Negotiable Jobsite Rules for Floating Floors:
* **Conduit and Plumbing Routing**: Fasten all electrical conduits and insulated PEX supply lines directly to the bare subfloor *before* laying the acoustic boards. If running thick conduit clusters or drain lines, embed them in a lightweight leveling sub-pour first. Slicing acoustic boards into ribbons around pipes destroys the continuous isolation blanket and creates severe direct sound bridges.
* **Doorway Control Joints (Acoustic Breaks)**: Place a decoupled control joint with perimeter isolation foam under every interior door threshold. This breaks the structural continuity of the screed slab between rooms, preventing heel-strike footsteps in high-traffic hallways from flanking into quiet bedrooms.
* **Baseboard Fastening (Preventing Short Circuits)**: Nail baseboard trim strictly to the wall studs—never cross-fasten it into the floating floor. Keep the bottom edge of the trim elevated 1/16" to 1/8" (1.5–3 mm) above the finished floor and seal the gap with flexible acoustical sealant. Nailing baseboards into both the wall and floor creates a rigid mechanical tie that bypasses the floating floor entirely.
...
### The High-Performance Acoustic Layer Stack (as diagrammed):
* **Structural Wall & Subfloor Slab**: Mass concrete/block base decoupled from the framing.
...
* **Eco Board (Insulation Board)**: Sound-absorbing acoustic mineral wool (2.8–3.7 lbs/cu ft or 45–60 kg/m³) filling the cavity.
* **Gypsum Fiberboard (GWB)**: Dense high-mass first sheathing layer (1/2" or 5/8").
* **Gypsum Board (Drywall)**: Heavy soundproof drywall outer layer with staggered seams and non-hardening acoustical sealant.
