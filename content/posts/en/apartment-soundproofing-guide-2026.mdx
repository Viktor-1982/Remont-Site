...
* **Waterproofing Membrane**: Heavy-duty 6 mil (150–200 µm) polyethylene sheeting protecting the insulation core from moisture and cement slurry.
* **Sound Insulation Material**: High-density acoustic mineral wool boards (6.2–8.7 lbs/cu ft or 100–140 kg/m³, 0.8"–1.2" thick) dampening impact and airborne vibrations.
* **Cement-Sand Screed**: Minimum 2.0"–2.4" (50–60 mm) fiber-reinforced mortar screed floating entirely isolated above the resilient core.
* **Reinforcing Mesh**: Embedded welded wire grid (2"x2" / 50x50 mm) providing tensile strength and crack resistance.
* **Damper Tape**: Closed-cell perimeter damping foam strip preventing structural flanking vibrations to adjoining walls.
* **Base (Wall)**: Main boundary wall completely decoupled from the floating floor slab.
