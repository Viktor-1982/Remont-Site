...
/**
 * Static pages config.
 * IMPORTANT: English canonical URLs use NO locale prefix (EN = primary language).
 * Russian pages use /ru/ prefix.
 * DO NOT use /en/... paths here — those are rewrite aliases, not canonical URLs.
 */
const staticPageConfig = [
    ...
    { path: "/calculators/drywall",            changeFrequency: "monthly" as const, priority: 0.7 },
    { path: "/ru/calculators/drywall",         changeFrequency: "monthly" as const, priority: 0.7 },
...
function getTagPages() {
    ...
    // EN tag pages: canonical URL without /en/ prefix
