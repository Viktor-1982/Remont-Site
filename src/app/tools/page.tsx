...
export const metadata = getPageMetadata("/tools", {
    ...
    description:
        "Современные инструменты для ремонта: краска, обои, плитка, вентиляция, тёплый пол, планировщик бюджета. Точные расчёты материалов и стоимости для квартиры и дома.",
