...
export const metadata: Metadata = {
    ...
    keywords: [
        ...
        "tile calculator for bathroom and floor",
        "flooring estimator laminate vinyl wood",
        "paint calculator for walls and ceiling",
        "underfloor heating power calculator",
        "room ventilation air changes calculator",
        "lighting lumens calculator",
        "small apartment interior design ideas",
        "diy home renovation tips",
        "bathroom remodel budget planner",
    ],
    icons: {
