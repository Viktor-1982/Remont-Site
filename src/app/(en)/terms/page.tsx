          ...
          <CardContent className="space-y-6">
            ...
            <div>
              ...
              <ul className="space-y-2 text-muted-foreground">
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 dark:text-green-400 mt-0.5 shrink-0" />
                  <span><strong className="text-foreground">Ask questions</strong> by email</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 dark:text-green-400 mt-0.5 shrink-0" />
        ...
        <Card className="border-2 border-blue-500/20 bg-gradient-to-br from-card to-blue-500/5 dark:to-blue-500/10 shadow-lg">
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground leading-relaxed">
              ...
              please see our <Link href="/privacy" className="text-primary hover:underline font-medium">Privacy Policy</Link>.
            </p>
          </CardContent>
        </Card>
