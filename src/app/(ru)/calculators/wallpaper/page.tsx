    ...
    return (
        <main className="max-w-2xl mx-auto py-10 px-4">
            ...
            <p className="text-muted-foreground mb-8 text-lg leading-relaxed">
                ...
                Учитывается площадь стен, окна, двери и раппорт рисунка. Проемы уменьшают расчет по эквивалентной площади, но для запаса все равно лучше брать еще один рулон.
            </p>
            <WallpaperCalculator />
            ...
            <section className="mt-10 relative overflow-hidden rounded-2xl border-2 border-primary/20 bg-gradient-to-br from-primary/5 via-primary/5 to-accent/5 dark:from-primary/10 dark:via-primary/10 dark:to-accent/10 px-6 py-8 shadow-xl">
                ...
                <div className="relative z-10">
                    ...
                    <ul className="space-y-3 text-sm text-muted-foreground">
                        ...
                        <li>
                            <span className="font-medium text-foreground">Учет окон и дверей.</span> Проемы уменьшают эквивалентную площадь оклейки, поэтому расчет ближе к реальному расходу, чем грубый подсчет по периметру.
                        </li>
                        <li>
            ...
            <section className="mt-10 relative overflow-hidden rounded-2xl border-2 border-primary/20 bg-gradient-to-br from-primary/5 via-primary/5 to-accent/5 dark:from-primary/10 dark:via-primary/10 dark:to-accent/10 px-6 py-8 shadow-xl">
                ...
                <div className="relative z-10">
                    ...
                    <ol className="list-decimal ml-5 space-y-2 text-sm text-muted-foreground">
                        <li>Выберите расчет по комнате или по одной стене и введите соответствующие размеры в метрах.</li>
                        <li>Укажите размеры рулона: длину и ширину (обычно указано на упаковке).</li>
                        <li>Для обоев с рисунком укажите высоту раппорта.</li>
                        <li>Добавьте окна и двери — калькулятор уменьшит расход по эквивалентной площади проемов.</li>
