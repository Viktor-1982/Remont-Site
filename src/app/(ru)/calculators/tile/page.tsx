    ...
    return (
        <main className="max-w-2xl mx-auto py-10 px-4">
            ...
            <p className="text-muted-foreground mb-8 text-lg leading-relaxed">
                Рассчитайте количество плитки для пола или одной стены. 
                Учитываются размеры поверхности, размеры плитки, ширина швов, способ укладки, окна, двери, ванна/экран, отходы на подрезку, количество упаковок и необходимое количество клея.
            </p>
            <TileCalculator />
            ...
            <section className="mt-10 relative overflow-hidden rounded-2xl border-2 border-primary/20 bg-gradient-to-br from-primary/5 via-primary/5 to-accent/5 dark:from-primary/10 dark:via-primary/10 dark:to-accent/10 px-6 py-8 shadow-xl">
                ...
                <div className="relative z-10">
                    ...
                    <ol className="list-decimal ml-5 space-y-2 text-sm text-muted-foreground">
                        ...
                        <li>Для пола введите размеры помещения: длину и ширину в метрах.</li>
                        <li>Для стены введите ширину стены и высоту облицовки в метрах. Если облицовывается несколько стен, рассчитайте их по отдельности.</li>
                        ...
                        <li>Для стен укажите количество и площадь окон и дверей на этой стене.</li>
            ...
            <section className="mt-12">
                ...
                <div className="space-y-4 text-sm text-muted-foreground">
                    <details className="group rounded-lg border bg-card px-4 py-3 open:bg-card/80">
                        ...
                        <p className="mt-2">
                            Введите точные размеры поверхности и плитки, укажите ширину шва, количество плиток в упаковке, окна и двери (для выбранной стены), 
