...
const dictionary = getCalculatorPageDictionary("ru", "underfloorHeating")
...
export default function UnderfloorHeatingPage() {
    return <CalculatorPageTemplate dictionary={dictionary} widget={<UnderfloorHeatingCalculator />} />
}
