...
export default function BookmarksPage() {
    const { getBookmarksByLocale, removeBookmark } = useBookmarks()
    const [showClearConfirm, setShowClearConfirm] = useState(false)
    const bookmarkPosts = getBookmarksByLocale("ru")
    const t = navData.ru.bookmarks

    const handleClearAll = () => {
        bookmarkPosts.forEach((bookmark) => {
