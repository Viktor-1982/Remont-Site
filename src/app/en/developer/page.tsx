...
export default function DeveloperPageEn() {
    const structuredData = {
        "@context": "https://schema.org",
        "@type": "Person",
        name: "ViktorWebStudio",
        jobTitle: "Web Developer",
        description: "Web Development & Design. Creating modern, beautiful and functional websites.",
        url: "https://renohacks.com/en/developer",
        knowsAbout: [
            "Web Development",
            "Web Design",
            "Next.js",
            ...
            <main className="container mx-auto px-4 py-12 max-w-4xl">
                ...
                <div className="bg-card rounded-2xl shadow-xl p-8 md:p-12 border">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-xl text-primary mb-4">Web Development & Design</p>
                        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                            We create modern, beautiful and functional websites using cutting-edge technologies.
                        </p>
                    </div>
