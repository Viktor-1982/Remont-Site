        ...
        paint: {
            ...
            related: {
                ...
                cards: [
                    ...
                    { href: "/calculators", title: "Все калькуляторы", description: "Изучите полный набор инструментов Renohacks для планирования материалов.", icon: "paintbrush", accentClass: "text-rose-500" },
                ],
            },
        ...
        paint: {
            ...
            related: {
                ...
                cards: [
                    ...
                    { href: "/en/calculators", title: "All Calculators", description: "Explore the full Renohacks toolkit for planning materials.", icon: "paintbrush", accentClass: "text-rose-500" },
                ],
            },
