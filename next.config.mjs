                ...
                headers: [
                    // Content Security Policy
                    {
                        ...
                        value: [
                            ...
                            "font-src 'self' data:",
                            "connect-src 'self' https://www.googletagmanager.com https://mc.yandex.ru https://mc.yandex.com https://mc.yandex.md wss://mc.yandex.com https://www.google-analytics.com https://ep1.adtrafficquality.google https://ep2.adtrafficquality.google https://h.clarity.ms https://k.clarity.ms https://openrouter.ai https://googleads.g.doubleclick.net https://tpc.googlesyndication.com",
                            "frame-src https://www.googletagmanager.com https://mc.yandex.md https://www.google.com https://ep2.adtrafficquality.google https://googleads.g.doubleclick.net https://tpc.googlesyndication.com",
                            "object-src 'none'",
                            "base-uri 'self'",
                            "form-action 'self'",
